package uk.org.retallack.claymodeler
...
import uk.org.retallack.claymodeler.renderer.ModelRenderer
import uk.org.retallack.claymodeler.tool.LightModeTool
import uk.org.retallack.claymodeler.viewmodel.ModelingViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var cursorView: uk.org.retallack.claymodeler.renderer.ToolCursorView
    private lateinit var fileManager: uk.org.retallack.claymodeler.file.FileManager
    private lateinit var stlExporter: uk.org.retallack.claymodeler.export.STLExporter
    
    private var lastTouchX = 0f
    private var lastTouchY = 0f
    private var pointerCount = 0
    private var hasAppliedTool = false
    private var previousHitPoint: uk.org.retallack.claymodeler.model.Vector3? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fileManager = uk.org.retallack.claymodeler.file.FileManager(this)
        
        // Initialize STL exporter
        stlExporter = uk.org.retallack.claymodeler.export.STLExporter(this)
        ...
        // Add cursor overlay
        cursorView = uk.org.retallack.claymodeler.renderer.ToolCursorView(this)
    ...
    private fun updateToolSelection(tool: uk.org.retallack.claymodeler.tool.Tool) {
        // Reset all buttons
                    ...
                    1 -> {
                        ...
                        if (viewModel.toolEngine.isEditMode()) {
                                ...
                                if (hit != null) {
                                    ...
                                    if (model != null && tool != null) {
                                        ...
                                        val dragDir = if (previousHitPoint != null) {
                                            ...
                                            uk.org.retallack.claymodeler.model.Vector3(0f, 0f, 0f)
                                        }
                            ...
                            if (model != null) {
                                ...
                                model.lightPosition = uk.org.retallack.claymodeler.model.Vector3(
    ...
    private fun showSaveDialog() {
        uk.org.retallack.claymodeler.ui.SaveDialog(this) { filename ->
            try {
    ...
    private fun showLoadDialog() {
        ...
        uk.org.retallack.claymodeler.ui.LoadDialog(this, files) { filename ->
            try {
    ...
    private fun showExamplesDialog() {
        val exampleManager = uk.org.retallack.claymodeler.examples.ExampleManager(this)
        ...
        uk.org.retallack.claymodeler.ui.ExampleBrowserDialog(this, examples) { filename ->
    ...
    private fun showExportDialog() {
        uk.org.retallack.claymodeler.ui.ExportDialog(this) { filename, size, validate ->
            try {
    ...
    private fun launchExportWizard() {
        ...
        uk.org.retallack.claymodeler.ui.wizard.ExportWizardActivity.modelHolder = model.clone()
        startActivity(android.content.Intent(this, uk.org.retallack.claymodeler.ui.wizard.ExportWizardActivity::class.java))
    }
