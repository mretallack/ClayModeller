package uk.org.retallack.claymodeler.export.placement

import uk.org.retallack.claymodeler.export.PlacementResult
import uk.org.retallack.claymodeler.model.ClayModel
import uk.org.retallack.claymodeler.renderer.Octree
import uk.org.retallack.claymodeler.renderer.RayCaster
...
class SurfacePicker(private val rayCaster: RayCaster = RayCaster()) {
    ...
    private fun findFaceIndex(origin: uk.org.retallack.claymodeler.model.Vector3, direction: uk.org.retallack.claymodeler.model.Vector3, model: ClayModel): Int {
