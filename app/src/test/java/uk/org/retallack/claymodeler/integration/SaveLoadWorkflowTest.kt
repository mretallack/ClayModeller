package uk.org.retallack.claymodeler.integration

import android.content.Context
import uk.org.retallack.claymodeler.file.FileManager
...
class SaveLoadWorkflowTest : FunSpec({
    ...
    test("undo redo workflow maintains model integrity") {
        ...
        model.vertices.add(uk.org.retallack.claymodeler.model.Vector3(5f, 5f, 5f))
